...
<div id="gdpr_consent_{$psgdpr_id_module|escape:'htmlall':'UTF-8'}" class="gdpr_module gdpr_module_{$psgdpr_id_module|escape:'htmlall':'UTF-8'}">
    <div class="custom-checkbox" style="display: flex;">
        ...
        <label for="psgdpr_consent_checkbox_{$psgdpr_id_module|escape:'htmlall':'UTF-8'}" class="psgdpr_consent_message" style="display: inline">

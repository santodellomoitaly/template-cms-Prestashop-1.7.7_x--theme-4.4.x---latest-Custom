...
class PH_SimpleBlogSingleModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        $this->context->smarty->assign('alternativePostLangsUrls', $this->SimpleBlogPost->getAlternativeLangsPostUrl());
    ...
    public function getBreadcrumbLinks()
    {
        ...
        if ($this->SimpleBlogPost->parent_category){
            $breadcrumb['links'][] = [
                'title' => $this->SimpleBlogPost->parent_category->name,
                'url' => SimpleBlogCategory::getLink($this->SimpleBlogPost->parent_category->link_rewrite, $id_lang)
            ];
        }

        $breadcrumb['links'][] = [
            'title' => $this->SimpleBlogPost->category,
            'url' => $this->SimpleBlogPost->category_url
        ];

        $breadcrumb['links'][] = [
            'title' => $this->SimpleBlogPost->title,
            'url' => $this->SimpleBlogPost->url
        ];
        return $breadcrumb;
    }

...
{block name='head_seo_canonical'}
	{if $is_category}
		<link rel="canonical" href="{SimpleBlogPost::getPageLink($p, 'category', $blogCategory->link_rewrite)}">
	{else}
		<link rel="canonical" href="{SimpleBlogPost::getPageLink($p, false, false)}">
	{/if}
{/block}

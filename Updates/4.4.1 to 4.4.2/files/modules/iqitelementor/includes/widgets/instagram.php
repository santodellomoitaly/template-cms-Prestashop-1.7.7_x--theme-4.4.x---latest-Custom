...
class Widget_Instagram extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'instagram_api_type',
            [
                'label' => \IqitElementorWpHelper::__( 'Connection type', 'elementor' ),
                'type' => Controls_Manager::SELECT,
                'section' => 'section_instagram',
                'options' => [
                    'token' => \IqitElementorWpHelper::__( 'With access token', 'elementor' ),
                    'notoken' => \IqitElementorWpHelper::__( 'Without access token', 'elementor' ),
                ],
                'default' => 'notoken',
            ]
        );
    ...
    protected function render( $instance = [] ) {
        ...
        $instagram_options = [
            'api_type' => $instance['instagram_api_type'],
            'token' => $instance['instagram_token'],
            'user' => $instance['instagram_user'],
            'tag' => $instance['instagram_tag'],
            'feed_type' => $instance['instagram_type'],
            'limit_user' => (int)$instance['instagram_limit_user'],
            'limit_tag' => (int)$instance['instagram_limit_tag'],

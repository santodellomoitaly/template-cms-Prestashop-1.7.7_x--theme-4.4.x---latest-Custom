...
class IqitElementorContent extends ObjectModel
{
    ...
    {
        $usableHooks = ['displayBanner', 'displayShoppingCartFooter', 'displayAboveMobileMenu', 'displayBelowMobileMenu',
            'displayFooterProduct', 'displayCheckoutFooter', 'displayShoppingCart', 'displayFooter', 'displayFooterBefore', 'displayFooterAfter',
            ...
            'displayReassurance', 'displayRightColumnProduct', 'displayAfterProductThumbs2',  'displayProductAdditionalInfo',  'displayBelowHeader'];

...
class IqitHtmlAndBannerRepository
{
    ...
    {
        $usableHooks = ['displayFooter', 'displayCheckoutFooter', 'displayAboveMobileMenu', 'displayBelowMobileMenu', 'displayFooterBefore', 'displayFooterProduct', 'displayFooterAfter',

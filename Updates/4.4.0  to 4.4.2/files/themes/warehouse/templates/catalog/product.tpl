                ...
                <div class="product-information">
                    {block name='product_description_short'}
                        <div id="product-description-short-{$product.id}"
                             itemprop="description" class="rte-content product-description">{$product.description_short nofilter}</div>
                    {/block}
                                    ...
                                    <div id="product-accessories-sidebar" class="swiper-container">
                                        <div class="swiper-wrapper">
                                            {foreach from=$accessories item="product_accessory" key="position"}
                                                {block name='product_miniature'}
                                                    <div class="swiper-slide"> {include file='catalog/_partials/miniatures/product-small.tpl' product=$product_accessory carousel=true elementor=true richData=true position=$position}</div>
                                                {/block}
                                            {/foreach}
                                        </div>
